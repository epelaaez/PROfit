...
namespace PROfit{
    ...
    class PROspec {
        ...
        public:
            ...
            TH1D toTH1D(const PROconfig& inconfig, int subchannel_index, int other_index = 0) const;
            TH1D toTH1D(const PROconfig& inconfig, const std::string& subchannel_fullname, int other_index = 0) const;

            TH1D toTH1D_Collapsed(const PROconfig& inconfig, int channel_index, size_t var_index=0) const;
